...
$(function () {
    ...
    $('.js-header__nav-btn').on('click', function () {
        if (!$body.hasClass('is_menu_open')) {
            ...
            $("#btn_spmenu span").css("backgroundColor","#b60005");
            $(".l-header__nav-btn").css("backgroundColor","#fff");
            ...
            $("#btn_spmenu span").css("backgroundColor","#fff");
            $(".l-header__nav-btn").css("backgroundColor","#f08300");
        }
    });
